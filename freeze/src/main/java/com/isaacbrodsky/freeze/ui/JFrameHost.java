...
public class JFrameHost implements ZHost {
	...
	public JFrameHost(boolean fullscreen, HashMap<String, String> params) {
		...
		z = new ZGame(this);
		z.init();
		z.setPreferredSize(new Dimension(640, 400));
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.isaacbrodsky.freeze.ui.ZHost#getParent()
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.isaacbrodsky.freeze.ui.ZHost#getParameter(java.lang.String)
	 */
	@Override
