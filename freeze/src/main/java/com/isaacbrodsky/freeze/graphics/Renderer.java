...
public final class Renderer {
	public static final int DISPLAY_WIDTH = ZBoard.BOARD_WIDTH;
	public static final int DISPLAY_HEIGHT = ZBoard.BOARD_HEIGHT;

	public static final ElementColoring SYS_COLOR = new ElementColoring(
			"WHITE", "BLACK");
	...
	public void renderThrowable(Throwable t) {
		...
		renderText(0, dispLine++, ZGame.APP, new ElementColoring("GRAY",
				"BLACK"));
		renderText(0, dispLine++, t.toString(), new ElementColoring("RED",
				"BLACK"));
		...
		ElementColoring ec = new ElementColoring("YELLOW", "BLACK");
	...
	public ElementColoring getFlashingColor(int idx) {
		int i = (idx % 8) + 9;
		if (i == 8 + 9)
			i = 8;
		return new ElementColoring(i, 0);
	}

	public ElementColoring getFlashingColor() {
		return new ElementColoring((flashing % 8) + 8, 0);
	}
