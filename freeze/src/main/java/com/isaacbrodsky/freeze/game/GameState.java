...
public class GameState {
	...
	public GameState(int boards, int ammo, int gems, int[] keys, int health,
			int startBoard, int torches, int tcycles, int ecycles, int score,
			String gameName, String[] flags, int timePassed, int isSave,
			int stones) {
		this.boards = boards;
		this.ammo = ammo;
		this.gems = gems;
