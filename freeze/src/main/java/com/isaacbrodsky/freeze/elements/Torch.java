 ...
 * 
 */
public class Torch extends AbstractElement {
	private static final int TORCH_AMOUNT = 1;

	private ElementColoring color;

	public Torch() {
		this.color = new ElementColoring(6, ElementColoring.ColorMode.DOMINANT);
	}
	...
	public SaveData getSaveData() {
		return new SaveData(0x06, color);
	}
	...
	public void message(GameController game, Board board, Message msg) {
		if (msg.isTouch()) {
			game.getState().torches += TORCH_AMOUNT;
		}
	}
