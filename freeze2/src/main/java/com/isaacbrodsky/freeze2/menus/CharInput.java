 ...
 * 
 */
public class CharInput<T> extends MenuUtils implements UIInteraction,
		TypingInteraction {
	...
	public CharInput(String title, MenuCallback<T> callback, boolean cancellable,
			T rider) {
	...
	public CharInput(String title, MenuCallback<T> callback, boolean cancellable,
			T rider, int y, boolean useCodes) {
