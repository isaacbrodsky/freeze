 ...
 * 
 */
public class SelectInput<T> extends MenuUtils implements UIInteraction {
	 ...
	 * @param rider
	 */
	public SelectInput(String title, List<String> data, MenuCallback<T> callback,
			boolean singleLetter, boolean cancellable, T rider,
			int selected, int y) {
	...
	public SelectInput(String title2, String[] strings, MenuCallback callback2,
			boolean singleLetter, boolean cancellable2, T rider2,
			int selected) {
